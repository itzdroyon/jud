...
local seatbeltEjectSpeed = 200.0 
local seatbeltEjectAccel = 50.0
...
Citizen.CreateThread(function()
	   ...
	   local money
        ...
        for i=1, #ESX.PlayerData.accounts, 1 do
          ...
          elseif ESX.PlayerData.accounts[i].name == 'bank' then
			...
			elseif ESX.PlayerData.accounts[i].name == 'diamantes' then
                diamantes = ESX.PlayerData.accounts[i].money
	...
	SendNUIMessage({ action = 'setMoney', id = 'diamantes', value = diamantes })
...
RegisterCommand('hud', function()
	if not toggleui then
		...
		SendNUIMessage({ action = 'element', task = 'disable', value = 'diamantes' })
		...
		if (Config.ui.showDiamantesMoney == true) then
			SendNUIMessage({ action = 'element', task = 'enable', value = 'diamantes' })
		end
